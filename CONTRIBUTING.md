...
> [!TIP]
> You should use a Python environment dedicated to Nipoppy development (see the [documentation](https://nipoppy.readthedocs.io/en/latest/contributing.html#developer-environment-setup) for instructions).
