...
from nipoppy.core._constants import BIDS_PATH_INJECTION_PREFIX, ContainerCommandEnum
...
from nipoppy.workflows.process import (
    ProcessingRunner,
...
def test_run_single_bids_path_injection_with_pybids_database(
    ...
    mocked_get_bids_paths_to_inject = mocker.patch(
        "nipoppy.workflows.process._get_bids_paths_to_inject",
