...
- Python API: {class}`nipoppy.workflows.track_processing.PipelineTracker`
...
See the API reference for {class}`nipoppy.workflows.track_processing.PipelineTracker` for more information on optional arguments (they correspond to the ones for the [CLI](<project:../../cli_reference/track_processing.rst>)).
