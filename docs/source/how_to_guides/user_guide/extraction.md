...
- Python API: {class}`nipoppy.workflows.extract.ExtractionRunner`
...
See the API reference for {class}`nipoppy.workflows.extract.ExtractionRunner` for more information on optional arguments (they correspond to the ones for the [CLI](<project:../../cli_reference/extract.md>)).
