...
- Python API: {class}`nipoppy.workflows.process.ProcessingRunner`
...
See the API reference for {class}`nipoppy.workflows.process.ProcessingRunner` for more information on optional arguments (they correspond to the ones for the [CLI](<project:../../cli_reference/process.rst>)).
