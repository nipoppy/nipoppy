...
We can use the [`nipoppy init`](../../reference/cli_reference/init) command with the `--bids-source` option to directly add the BIDS directory to the Nipoppy dataset:
