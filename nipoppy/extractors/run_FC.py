...
def run_FC(
    ...
    try:
        for brain_atlas in brain_atlas_list:
            ...
            print(
                f"Successfully completed FC assessment for participant: {participant_id}"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--brain_atlas_list",
        type=json.loads,
        help="list of brain atlases to use for FC assessment",
    )
    parser.add_argument(
        "--confound_strategy", type=str, help="confound strategy for FC assessment"
    )
    parser.add_argument(
        "--metric_list",
        type=json.loads,
        help="list of metrics to use for FC assessment",
    )
    parser.add_argument(
