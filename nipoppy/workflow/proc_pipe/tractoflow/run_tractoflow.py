...
if __name__ == '__main__':
    ...
    # trackers aren't sufficiently modular to be usefully reused here.
    # run the tracker to see if it's complete
    # run_tracker.run(global_configs,
    #                 dash_schema_file=Path(global_configs["DATASET_ROOT"], "proc", "bagel_schema.json"),
    #                 pipelines="tractoflow")



    if complete:
        # move files from work to output to get rid of simlinks
        # then remove input/work directories
    else:
        # print some warning that indicates the pipeline didn't finish
