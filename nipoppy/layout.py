...
class DatasetLayout(Base):
    ...
    def __init__(
        ...
        self.fpath_doughnut: Path = self.get_full_path(self.config.fpath_doughnut.path)
        self.fpath_manifest: Path = self.get_full_path(self.config.fpath_manifest.path)
        self.fpath_imaging_bagel: Path = self.get_full_path(
            self.config.fpath_imaging_bagel.path
        )
