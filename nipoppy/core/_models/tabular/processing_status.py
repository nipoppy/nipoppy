...
class ProcessingStatusModel(BaseTabularModel):
    """
    ...
    but it can be thought of as a schema for each row in the processing status file.
    """
...
class ProcessingStatusTable(BaseTabular):
    ...
    # for sorting/comparing between processing status files
    index_cols = [
        col_participant_id,
