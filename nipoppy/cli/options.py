...
def runners_options(func):
    ...
    func = click.option(
        ...
        help=(
            ...
            "The file should have no headers, the first column should contain "
            f"participant IDs (without the {BIDS_SUBJECT_PREFIX} prefix), and the "
            "second column should contain session IDs (without the "
